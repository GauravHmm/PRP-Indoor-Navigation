...
const A_NODES: NavNode[] = [
  ...
  // Bottom
  { id: "A_G43", x: 780, y: 225, floor: 1, block: "A", type: "room", name: "G43", description: "A block" },
]
...
const C_NODES: NavNode[] = [
  ...
  { id: "C_stat", x: 448, y: 532, floor: 1, block: "C", type: "room", name: "Stationary", description: "stat" },
...
const D_NODES: NavNode[] = [
  ...
  { id: "D_G72", x: 345, y: 672, floor: 1, block: "D", type: "room", name: "G72" },
...
const B_NODES: NavNode[] = [
  ...
  // Rooms around corridor
  { id: "B_G60", x: 648, y: 670, floor: 1, block: "B", type: "room", name: "G60" },
  { id: "B_G61", x: 655, y: 680, floor: 1, block: "B", type: "room", name: "G61" },
  { id: "B_mr", x: 660, y: 686, floor: 1, block: "B", type: "room", name: "Men's WR" },
  ...
  { id: "B_wr", x: 680, y: 725, floor: 1, block: "B", type: "room", name: "Women's WR" },
]
...
export const navEdges: NavEdge[] = [
  ...
  { from:"C_G70",to:"L1_lc3",distance:8,floor:1,type:"corridor" },
  { from:"L1_sl",to:"L1_lc1",distance:8,floor:1,type:"corridor" },
  ...
  { from:"C_G02",to:"R1_lc1",distance:8,floor:1,type:"corridor" },
  { from:"C_G07",to:"R1_lc2",distance:8,floor:1,type:"corridor" },
  { from:"C_G09",to:"R1_lc3",distance:8,floor:1,type:"corridor" },
  { from:"C_G06",to:"R1_rc1",distance:8,floor:1,type:"corridor" },
  { from:"C_G08",to:"R1_rc2",distance:8,floor:1,type:"corridor" },
  { from:"C_G11",to:"R1_rc3",distance:8,floor:1,type:"corridor" },
  { from:"R1_sl",to:"R1_rc1",distance:8,floor:1,type:"corridor" },
  // R1→R2 (smooth)
  ...
  { from:"C_G01",to:"R2_rc1",distance:8,floor:1,type:"corridor" },
  { from:"C_G03",to:"R2_rc2",distance:8,floor:1,type:"corridor" },
  { from:"C_G04",to:"R2_rc3",distance:8,floor:1,type:"corridor" },
  { from:"R2_sl",to:"R2_rc1",distance:8,floor:1,type:"corridor" },
  { from:"C_G10",to:"R2_lc2",distance:8,floor:1,type:"corridor" },
  // R2→R3 (smooth)
